<?php
// FSA Shortcodes data for Cartel
...
array_push($FSA_shortcode_info['Content Styling']['shortcode_data'],
	array(
		...
		'description'=>'Blockquote <br><strong>Note:</strong> If using the "Striped" blockquote, wrap the quote with the [span] shortcode. E.g. [span]My quote here[/span]',
		'is_block_level' => null,
		'shortcode_icon'=>'udthemes_sc_styling-blockquote',
		'attributes' => array (
			'blockquote_style'=> array('default','boxed','boxed-background','elegant','overlayed','striped'),
...
array_push($FSA_shortcode_info['Media']['shortcode_data'],
	array(
		...
		'attributes' => array (
				...
				'caption_style' => array('impact','boxed','elegant','single-border','striped'),
				'caption_width' => '',
				'caption_align' => array('top-left','center-left','bottom-left','top-right','center-right','bottom-right','center'),
				'link' => '',
				'link_title' => '',
				'style' => ''
			),
...
array_push($FSA_shortcode_info['Media']['shortcode_data'],
	array(
		...
		'attributes' => array (
				'media_type' => array('image','iframe','soundcloud'),
				'thumbnail_url' => '',
				'url'=>'',
				'link_title' => '',
				'rollover_text' => '',
...
array_push($FSA_shortcode_info['Media']['shortcode_data'],
	array(
		...
		'attributes' => array (
				'id' => '',
				'size' => array('thumbnail','blog-width','full-width','full-size'),
				'style' => ''
			)
	));
...
array_push($FSA_shortcode_info['Media']['shortcode_data'],
	array(
		'shortcode_name'=>'soundcloud',
		'shortcode_title'=>'SoundCloud',
		'is_block_level' => null,
		'description'=>'Embed SoundCloud player.',
...
array_push($FSA_shortcode_info['Social Media']['shortcode_data'],
	array(
		'shortcode_name'=>'twitter_timeline_widget',
		'shortcode_title'=>'Twitter Timeline Widget',
		'description'=>'Embedd a Twitter Timeline Widget. <strong>Note:</strong> First log in to your Twitter account and go to <em>Settings -> Widgets</em> and create your widget. Then paste the code from Twitter into the textarea below. For more info please visit Twitter\\\'s <a href="https://dev.twitter.com/docs/embedded-timelines" title="Embedded Twitter Timelines" target="_blank">documentation on Embedded Timelines</a>.',
		'is_block_level' => null,
		...
		'attributes' => array (
				...
				'link_color' => '',
				'chrome_nofooter' => array('false','true'),
				'chrome_noborders' => array('false','true'),
				'chrome_noscrollbar' => array('false','true'),
				'chrome_transparent' => array('false','true'),
				'border_color' => '',
				'tweet_limit' => '',
				'style' => ''
			)
