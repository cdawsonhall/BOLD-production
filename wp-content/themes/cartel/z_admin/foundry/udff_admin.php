...
*/
	...
	// the Foundry version
	define("UDFFADMINVERSION", '3.1.3');
	// refer to version_history.txt for log
	...
	if(file_exists(get_template_directory ().'/z_usr/foundry/demoContents/')) {
		include(get_template_directory(). '/z_admin/class/Foundry_oneClickDemo.php');
		$foundry_oneClickDemo = new Foundry_oneClickDemo ();
	}
...
/* functions */
	...
	function udff_admin () {
		...
		<script>
			...
			var foundry_ajaxurl = "<?php echo admin_url()."admin-ajax.php"; ?>";
		</script>
